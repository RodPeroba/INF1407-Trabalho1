...
urlpatterns = [
    ...
    path("produtos/<str:categoria>/", views.PaginaCategoria.as_view(), name="pagina_categoria"),
    # User Registration URL
    path('registrar/', views.RegistraUsuario.as_view(), name='registrar_usuario'),
    path("accounts/profile/", LoginView.as_view(template_name='main/login.html'), name='segundo_login'),
    # Login and Logout URLs
    path('login/', LoginView.as_view(template_name='main/login.html',next_page = reverse_lazy('homepage')), name='login'),
